...
namespace Magenest\Rule\Model\Config\Backend;
...
/**
 * Class ClockType
 * @package Magenest\Movie\Model\Config\Backend
 */
class ClockType extends Value
{
    /**
    ...
    {
        $result = [];
        foreach ($value as $customerGroup => $clockType) {
            $id = $this->mathRandom->getUniqueHash('_');
            $result[$id] = ['customer_group' => $customerGroup, 'clock_type' => $clockType];
        }
        return $result;
    }
